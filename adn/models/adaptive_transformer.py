...
from adn.attention.block_attnres import BlockAttnRes, TwoPhaseBlockAttnRes
...
from adn.memory.engram import Engram
...
class AdaptiveTransformer(nn.Module):
    ...
    def init_rabitq_caches(self, total_bits: int = 1, residual_window: int = 128):
        ...
        """
        from adn.compression.rabitq import RaBitQCache
    ...
    def get_rabitq_memory_stats(self, seq_len: int, batch_size: int = 1) -> Dict[str, float]:
        ...
        from adn.compression.rabitq import RaBitQ
    ...
    def generate(
        ...
        if use_qttt == "adaptive" or ponder_gate_mode is not None:
            from adn.gating.ponder_gate import create_ponder_gate
            ...
            if should_run_qttt:
                ...
                with torch.enable_grad():
                    ...
                    if adaptive_qttt_mode is not None:
                        ...
                        from adn.qttt.adaptive_config import create_adaptive_config
    ...
    def generate_batch(
        ...
        """
        from adn.qttt.batch_adaptation import BatchAdaptiveContext, adapt_queries_batch_parallel
...
def create_adaptive_transformer(config_name: str = "medium", **kwargs) -> AdaptiveTransformer:
    ...
    from adn.core.config import get_config
