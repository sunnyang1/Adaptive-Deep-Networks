...
# Public API aliases used by ``adn.qasp``.
stiefel_projection = project_to_stiefel
"""Alias for :func:`project_to_stiefel` — preferred name in ADN public API."""

matrix_sign_function = project_to_stiefel
"""Alias for :func:`project_to_stiefel` — the Stiefel projection *is* the matrix sign function."""

newton_schulz = project_to_stiefel
"""Alias for :func:`project_to_stiefel` — the implementation uses the Newton-Schulz iteration."""
