...
class FLOPAnalyzer:
    ...
    def transformer_layer_flops(
        ...
        attn_flops = FLOPAnalyzer.attention_flops(batch, seq_len, num_heads, head_dim)
        mlp_flops = FLOPAnalyzer.mlp_flops(batch, seq_len, hidden_dim, mlp_ratio)
...
class EfficiencyAnalyzer:
    ...
    def compute_thinking_token_flops(
        ...
        # Per-layer FLOPs
        layer_flops = FLOPAnalyzer.transformer_layer_flops(
