...
from adn.memory.compressed_tokenizer import CompressedTokenizer
...
NgramHash = NgramHashMapping


def compute_ngram_hash(input_ids: np.ndarray, mapping: NgramHashMapping, layer_id: int) -> np.ndarray:
    """Compute n-gram hashes for a specific layer using a NgramHashMapping."""
    return mapping.hash(input_ids)[layer_id]
